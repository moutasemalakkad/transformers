...
class Qwen2VLProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs: Unpack[Qwen2VLProcessorKwargs],
        ...
        return BatchFeature(data={**text_inputs, **image_inputs, **videos_inputs, **audio_inputs}, tensor_type=return_tensors) # text_inputs: 3028 tokens, audio_inputs torch.Size([128, 3000])
