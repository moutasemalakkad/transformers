...
# Simulate  processor output (replace with real data)
...
mel_bins = 128  # From audio_values.shape[1]
time_steps = 3000  # From  audio_values.shape[2]
num_tokens = 3000  # audio pad tokens
...
print(" Config is compatible with processor!")
